...
\textit{$affiliation.institution.department$}\\
$endif$
\textit{$affiliation.institution.name$,
...
\IEEEauthorblockA{
\textit{$if(affiliation.institution.department)$$affiliation.institution.department$\\$endif$}%%
$affiliation.institution.name$\\
\textit{$affiliation.institution.location$}
