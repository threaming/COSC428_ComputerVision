...
if __name__ == "__main__":
    ...
    cfg.MODEL.WEIGHTS = "./instance_segmentation/logs/model_final.pth"

    register_coco_instances("my_dataset_train", {}, "./instance_segmentation/labels/cards_train.json", "./data/card_train")
    register_coco_instances("my_dataset_val", {}, "./instance_segmentation/labels/cards_test.json", "./data/card_test")

    metadata = MetadataCatalog.get(cfg.DATASETS.TEST[0])
    metadata.thing_classes = get_categories("./instance_segmentation/labels/cards_test.json")
